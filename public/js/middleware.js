;(function ($) {
    const whitelistOrigins = ['https://app.dev.pii.ai', 'https://app.pii.ai', 'http://localhost:9927', 'http://localhost:58002'];
    ...
    const _preview = {
        ...
        header: (request) => {
            const headerElement = document.querySelector('#home-jumbotron');
